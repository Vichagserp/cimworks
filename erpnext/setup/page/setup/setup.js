...
SetupData = function(cnty){
  ...
  this.system = {'System':[['Global Defaults',3,'Manage Account','','Set global default values'],
    ...
    ['Profile',1,'Profile','id'+NEWLINE+'enabled'+NEWLINE+'first_name'+NEWLINE+'email','Manage Profiles'],
  ...
  this.general = {'General':[['Authorization Rule',1,'Authorization Rule','','Set rules based on amounts'],
   ...
   // ['Term',1,'Term','','Manage template of standard Terms for order / invoices etc'],
    ['Terms And Conditions',1,'Terms And Conditions','','Manage template of standard Terms And Conditions for order / invoices etc'],
    ['Currency',1,'Currency','','Manage list of currencies'],
    ['Country',1,'Country','','Country master'],
    ['Contact',1,'Contact','','Manage contacts'],
  ...
  this.selling = {'Selling':[['Customer Group',2,'Sales Browser','Customer Group','Manage customer categories'],
    ...
    ['Sales Person',1,'Sales Person','territory'+NEWLINE+'email_id','Manage sales persons'],
    ...
    ['Order Lost Reason',1, 'Order Lost Reason', '', 'Order lost reason master'],
    ['Factor Figure', 1, 'Factor Figure', 'id'+NEWLINE+'factor_figure_rate', 'Factor Figure master'],
    ['Expense Limit', 1, 'Expense Limit', '', 'Expense limit master'],
    ['Slip Gauge', 1, 'Slip Gauge', '', 'Slip Gauge master'],
    ['Zone', 1, 'Zone', '', 'Manage Zones']]};
  ...
  this.stock = {'Stock':[['Item Group',1,'Item Group','parent_group_name','Manage item groups'],
    ['Item Type', 1, 'Item Type', '', 'Manage Item Types'],
    ['Item',1,'Item','product_code'+NEWLINE+'item_group'+NEWLINE+'description'+NEWLINE+'brand'+NEWLINE+'item_type'+NEWLINE+'stock_uom','Item master'],
  ...
  this.maintenance = {'Maintenance':[['Serial No',1,'Serial No','item_code'+NEWLINE+'brand'+NEWLINE+'item_type'+NEWLINE+'product_code'+NEWLINE+'status'+NEWLINE+'customer','Manage unique serial numbers for items'],
