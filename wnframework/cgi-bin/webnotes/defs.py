...
#
default_db_name = 'cimworks'
db_password = 'chintan1'
...
#
files_path = '/var/www/vhosts/default/htdocs/uploads'
...
#
modules_path = '/var/www/vhosts/default/htdocs/trimos/erpnext'
...
backup_path = '/var/www/vhosts/default/htdocs/backups_data/'

# where the latest dump will show up so that it can be
# downloaded from the web
backup_link_path = '/var/www/vhosts/default/htdocs/backups_data/'
